export const UI_COPY = {
  comparar: {
    title: "Comparador Normativo Avanzado",
    subtitle:
      "Compare versiones históricas o artículos diferentes con trazabilidad jurídica.",
  ...
  retencion: {
    wizardTitle: "¿Qué concepto aplica?",
    wizardSubtitle: "Le guiamos en 3 pasos.",
    resultTitle: "Resultado estimado para retención en la fuente.",
  },
  chat: {
    onboarding:
