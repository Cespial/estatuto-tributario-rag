  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="w-full rounded border border-border bg-card h-12 pl-10 pr-10 text-sm outline-none transition-colors placeholder:text-muted-foreground focus:border-foreground/40 focus:ring-1 focus:ring-foreground/20"
      />
      {local && (
        <button
          onClick={() => {
