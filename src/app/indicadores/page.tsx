      ...
      <div className="grid gap-8 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-8">
          <div className="relative">
            <input
              ...
              className="w-full rounded-md border border-border bg-background py-3 pl-4 pr-3 text-sm outline-none focus:border-primary focus:ring-1 focus:ring-primary shadow-sm"
            />
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {filteredIndicadores.length > 0 ? (
              filteredIndicadores.map((cat, idx) => (
                <div key={idx} className="flex flex-col gap-4 rounded-xl border border-border bg-card/50 p-6 shadow-sm">
                  <h2 className="text-lg font-bold border-b border-border pb-2 text-primary flex items-center gap-2">
                    {cat.categoria}
                  </h2>
                      ...
                      >
                        <div className="flex items-center justify-between gap-4">
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              ...
                              {item.articulo && (
                                <Link 
                                  ...
                                  className="inline-flex items-center gap-0.5 text-[10px] text-primary hover:underline opacity-0 group-hover:opacity-100 transition-opacity"
                                >
                                  Art. {item.articulo}
                            ...
                            {item.notas && (
                              <p className="mt-1 text-xs text-muted-foreground italic border-l-2 border-primary/20 pl-2">
                                {item.notas}
                              </p>
                            )}
                          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl border border-border bg-primary/5 p-6">
            <h3 className="font-semibold text-primary mb-2">Enlaces Rápidos</h3>
